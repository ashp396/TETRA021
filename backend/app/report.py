...
from app.scoring import REGULATORY_DISCLAIMER
...
def build_report_pdf(workspace_name: str, analysis: dict, documents: list[dict]) -> bytes:
    ...
    for key, label in [("pitch", "Pitch narrative"), ("financials", "Financial statements"),
                        ...
                        ("regHygiene", "Regulatory & disclosure hygiene")]:
    ...
    story.append(Paragraph(
        ...
        "provided. It is not a valuation and not an investment recommendation. " + REGULATORY_DISCLAIMER,
